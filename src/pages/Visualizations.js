    ...
    if (document.getElementById('viz1610193687947')) {
      ...
      if (document.getElementById('viz1610279567451')) {
        ...
        if (vizElementLocationsChart) {
          ...
          vizElementLocationsChart.style.height =
            divElementLocationsChart.offsetWidth * 0.75 + 'px';
          var scriptElementLocationsChart = document.createElement('script');
          scriptElementLocationsChart.src =
            'https://public.tableau.com/javascripts/api/viz_v1.js';
          vizElementLocationsChart.parentNode.insertBefore(
            scriptElementLocationsChart,
            vizElementLocationsChart
          );
        }
      }
    }
      ...
      <section className='section'>
        ...
        >
          <noscript>
            <a href='/visualizations'>
              <img
                alt='Data Table of All Menu Items'
      ...
      <section className='section'>
        ...
        >
          <noscript>
            <a href='/visualizations'>
              <img
                alt='Column Chart of Locations by Service Population'
                src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Da&#47;DataVizCafe&#47;LocationsbyServicePopulation&#47;1_rss.png'
                style={{ border: 'none' }}
              />
            </a>
          </noscript>
          <object class='tableauViz' style={{ display: 'none' }}>
            ...
            <param
              name='name'
              value='DataVizCafe&#47;LocationsbyServicePopulation'
            />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param
              name='static_image'
              value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Da&#47;DataVizCafe&#47;LocationsbyServicePopulation&#47;1.png'
            />{' '}
            <param name='animate_transition' value='yes' />
            <param name='display_static_image' value='yes' />
            <param name='display_spinner' value='yes' />
